 ...
 */
import { createAsset as createAssetRepo, deleteAsset as deleteAssetRepo, updateAsset as updateAssetRepo, findAssetById, findAllAssets, getTotalAllocatedUnits, createEvent, } from '../repositories/index.js';
/**
 * Create a new asset
 */
 ...
 */
export async function getAssetUtilization(assetId) {
