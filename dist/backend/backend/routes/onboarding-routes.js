...
import { applyToFund, checkEligibility, reviewApplication, allocateUnits, findOnboardingById, findOnboardingByAsset, findOnboardingByInvestor, } from '../services/onboarding-service.js';
const router = Router();
...
router.post('/:id/review', async (req, res) => {
    try {
        ...
        const result = await reviewApplication(req.params.id, decision, reviewedBy, rejection_reasons);
        if (!result.success) {
