...
import { simulateTransfer, executeTransfer, } from '../services/index.js';
import { findAllTransfers, findTransfersByAsset, getTransferHistory, } from '../repositories/index.js';
...
router.get('/', async (req, res) => {
    try {
        ...
        const transfers = await findTransfersByAsset(assetId);
        res.json(transfers);
    }
    catch (error) {
        res.status(500).json({
