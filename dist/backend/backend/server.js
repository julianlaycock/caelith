...
import { securityHeaders, authRateLimit, sanitizeInput, clearRateLimits } from './middleware/security.js';
...
app.post('/api/reset', authenticate, authorize('admin'), async (_req, res) => {
