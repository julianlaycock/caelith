...
export type LegalForm = 'SICAV' | 'SIF' | 'RAIF' | 'SCSp' | 'SCA' | 'ELTIF' | 'Spezial_AIF' | 'Publikums_AIF' | 'QIAIF' | 'RIAIF' | 'LP' | 'other';
export type RegulatoryFramework = 'AIFMD' | 'UCITS' | 'ELTIF' | 'national';
export type FundStatus = 'active' | 'closing' | 'closed' | 'liquidating';
export type DecisionType = 'transfer_validation' | 'eligibility_check' | 'onboarding_approval' | 'scenario_analysis';
...
export type EventType = 'asset.created' | 'asset.updated' | 'asset.deleted' | 'investor.created' | 'investor.updated' | 'holding.allocated' | 'holding.updated' | 'rules.created' | 'rules.updated' | 'transfer.executed' | 'transfer.rejected' | 'composite_rule.created' | 'composite_rule.updated' | 'composite_rule.deleted' | 'fund_structure.created' | 'fund_structure.updated' | 'eligibility.checked' | 'eligibility_criteria.created' | 'eligibility_criteria.updated' | 'onboarding.applied' | 'onboarding.eligible' | 'onboarding.ineligible' | 'onboarding.approved' | 'onboarding.rejected' | 'onboarding.allocated' | 'onboarding.withdrawn' | 'copilot.query' | 'copilot.rule_proposed';
export type EntityType = 'asset' | 'investor' | 'holding' | 'rules' | 'transfer' | 'composite_rule' | 'fund_structure' | 'eligibility_criteria' | 'decision_record' | 'onboarding_record' | 'regulatory_document';
