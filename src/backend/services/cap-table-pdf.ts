  ...
  return new Promise((resolve, reject) => {
    ...
    const doc = new PDFDocument({
      ...
      info: {
        ...
        Author: 'Codex Compliance Engine',
    ...
    doc.fontSize(8).fillColor('#64748b')
      .text('CODEX COMPLIANCE ENGINE', leftMargin, 30, { align: 'left' })
    ...
    doc.fontSize(7).fillColor('#94a3b8')
      .text(
        'This document was generated by Codex Compliance Engine. It represents a point-in-time snapshot and should not be considered legal or financial advice.',
