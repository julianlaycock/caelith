      ...
      <nav className="flex-1 overflow-y-auto px-3 py-2">
        {navSections.map((section) => (
          <div key={section.label} className="mb-4">
            <p className="mb-1.5 px-3 text-[10px] font-medium uppercase tracking-widest text-brand-400/60">
              {section.label}
            </p>
                ...
                return (
                  <Link
                    ...
                    className={classNames(
                      ...
                      active
                        ? 'border-l-2 border-brand-400 bg-white/[0.08] text-white'
                        : 'border-l-2 border-transparent text-brand-400 hover:bg-white/[0.05] hover:text-white'
                    )}
                  >
                    {item.icon}
                    {item.label}
      ...
      <div className="border-t border-white/10 p-4">
        ...
        {onCopilotToggle && (
          <button
            ...
            className="mb-2 flex w-full items-center gap-2.5 rounded-lg px-3 py-1.5 text-xs font-medium text-brand-300 transition-colors hover:text-white hover:bg-white/[0.05]"
          >
