        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card>
            ...
            <select
              ...
              className="block w-full rounded-lg border border-edge px-3 py-2 text-sm bg-white focus:outline-none focus:ring-1 focus:ring-[#000042]"
            >
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="block w-full rounded-lg border border-edge px-3 py-2 text-sm bg-white focus:outline-none focus:ring-1 focus:ring-[#000042] resize-none"
                />
              </div>
            </div>
          </Card>
